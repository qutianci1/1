...
-- @Last Modified time  : 2023-09-18 17:29:57
...
function 法术:法术取比例(攻击方, 挨打方)
    local ratio = 15.7
    ratio = ratio + (self.熟练度 - 1) * (96.2 - ratio) / (200 - 1)
    return ratio
end
...
function 法术:法术取描述()
    return string.format('在#R%s#W个回合内将遭受的法力伤害以#R%s%%#W转化为气血伤害。',
