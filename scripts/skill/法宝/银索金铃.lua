...
-- @Last Modified time  : 2023-09-18 10:21:19
...
function 法术:法术取比例(攻击方, 挨打方)
    local ratio = 15.7
    ratio = ratio + (self.熟练度 - 1) * (82 - ratio) / (200 - 1)
    return ratio
end
...
function 法术:法术取描述()
    return string.format('在#R%s#W个回合内将遭受的#R%s%%#W气血伤害转化为法力伤害。',
