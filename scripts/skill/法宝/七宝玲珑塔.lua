...
-- @Last Modified time  : 2023-09-18 10:20:55
...
function 法术:法术取比例(攻击方, 挨打方)
    local ratio = 15.7
    ratio = ratio + (self.熟练度 - 1) * (82.4 - ratio) / (200 - 1)
    return ratio
end
...
function 法术:法术取描述()
    return string.format('在#R%s#W个回合内将遭受到的#R%s%%#W法力伤害转化为气血伤害返还给对手。',
