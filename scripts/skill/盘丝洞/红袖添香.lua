...
-- @Last Modified time  : 2023-05-09 06:55:03
local 法术 = {
    类别 = '门派',
    类型 = 1,
    对象 = 1,
...
function 法术:取仙法()
    ...
    if self.熟练度>=25000 then
        临时法抗=24.85+(self.熟练度-25000)*0.0001
    elseif self.熟练度>=20000 then
        临时法抗=24.25+(self.熟练度-20000)*0.00012
    elseif self.熟练度>=15000 then
        临时法抗=23.5+(self.熟练度-15000)*0.00015
    elseif self.熟练度>=10000 then
        临时法抗=22.4+(self.熟练度-10000)*0.00022
    elseif self.熟练度>=5000 then
        临时法抗=20.7+(self.熟练度-5000)*0.00034
    else
        临时法抗=15.2+self.熟练度*0.0011
    end
    return 临时法抗
end
