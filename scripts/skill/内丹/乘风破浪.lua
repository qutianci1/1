...
-- @Last Modified time  : 2023-08-23 23:26:40
local 法术 = {
    类别 = '内丹',
    类型 = 2,
    对象 = 0,
...
--local _bid = {1307,1308,1309,1320} --修罗
--local _bid = {1301,1302,1303,1318} --天
--local _bid = {1304,1305,1306,1319} --人
--local _bid = {1310,1311,1312,1317} --魔
...
--   伤害=伤害*(1+self.参战单位[我].加强风/100)*(1-self.参战单位[敌].抗风/100+self.参战单位[我].忽视抗风/100)
