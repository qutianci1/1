...
-- @Last Modified time  : 2024-02-16 03:51:13
...
function 法术:法术取伤害(攻击方, 挨打方)
    local 震慑,扣蓝=0,0
    震慑 = 0.20 + 0.004 * math.pow(self.熟练度 , 0.35)
    扣蓝 = 0.03 + 0.005 * math.pow(self.熟练度 , 0.35)
...
function 法术:取HP伤害()
    local n = math.floor((0.20 + 0.004 * math.pow(self.熟练度 , 0.35)) * 10000)/100
    return n
end

function 法术:取MP伤害()
    local n = math.floor((0.03 + 0.005 * math.pow(self.熟练度 , 0.35)) * 10000)/100
    return n
end
